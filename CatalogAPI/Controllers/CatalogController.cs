...
namespace CatalogAPI.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        public ActionResult<CatalogItem> AddProductWithImage()
        {
            ...
            db.Catalog.InsertOne(catalogItem); //Save to Mongo DB
            
            BackupToTableAsync(catalogItem).GetAwaiter().GetResult(); //Backup to Azure Table Storage
        ...
        private async Task<CatalogEntity> BackupToTableAsync(CatalogItem item)
        {
            ...
            return await storageHelper.SaveToTableAsyc(item);
        }
    }
}